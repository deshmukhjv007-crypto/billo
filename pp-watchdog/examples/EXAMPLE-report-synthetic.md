...
|---|---|---|---|---|---|
| **SERVING A LARGER COPY THAN INSTAGRAM SHOWS** | InstaDP [demo] | http://127.0.0.1:38141/media/hires_1080x1080.png | 1080x1080 | same-photo | `http://127.0.0.1:38141/instadp/profile/j.v.d.7` |
| **SERVING AN OLD PICTURE OF YOU** | Dumpor [demo] | http://127.0.0.1:38141/media/stale.png | 320x320 | different-photo | `http://127.0.0.1:38141/dumpor/profile/j.v.d.7` |
| **SERVING YOUR CURRENT PICTURE** | Mollygram [demo] | http://127.0.0.1:38141/media/current.png | 320x320 | exact | `http://127.0.0.1:38141/mollygram/profile/j.v.d.7` |
| **PROFILE MIRRORED (image not independently retrieved)** | Bio Mirror [demo] | — | — | — | `http://127.0.0.1:38141/mirr/profile/j.v.d.7` |
| **BLOCKS CRAWLERS — CHECK BY HAND** | RobotsBlocked Viewer [demo] | — | — | — | `http://127.0.0.1:38141/blocked/profile/j.v.d.7` |
| **no cached copy found** | Dead Viewer [demo] | — | — | — | `http://127.0.0.1:38141/gone/profile/j.v.d.7` |

## Takedown targets

### InstaDP [demo]
- page: http://127.0.0.1:38141/instadp/profile/j.v.d.7
- copy: http://127.0.0.1:38141/media/hires_1080x1080.png
...
- captured markup: `<script>var user = {"username":"j.v.d.7","full_name":"Demo User", "profile_pic_url":"http://127.0.0.1:38141/media/hires_1080x1080.png"};</script> <a href="http://127.0.0.1:38141/media/hires_1080x1080.png" d`

### Dumpor [demo]
- page: http://127.0.0.1:38141/dumpor/profile/j.v.d.7
- copy: http://127.0.0.1:38141/media/stale.png
...
- abuse addresses harvested this run: <abuse@demo-mirror.invalid>
- scanner note: found via 'profile_pic_url'
- captured markup: `<script>var user = {"username":"j.v.d.7","full_name":"Demo User", "profile_pic_url":"http://127.0.0.1:38141/media/stale.png"};</script> <a href="http://127.0.0.1:38141/media/stale.png" download>Download ful`

### Mollygram [demo]
- page: http://127.0.0.1:38141/mollygram/profile/j.v.d.7
- copy: http://127.0.0.1:38141/media/current.png
...
- abuse addresses harvested this run: <abuse@demo-mirror.invalid>
- scanner note: found via 'profile_pic_url'
- captured markup: `<script>var user = {"username":"j.v.d.7","full_name":"Demo User", "profile_pic_url":"http://127.0.0.1:38141/media/current.png"};</script> <a href="http://127.0.0.1:38141/media/current.png" download>Download`

### Bio Mirror [demo]
- page: http://127.0.0.1:38141/mirr/profile/j.v.d.7
- abuse addresses harvested this run: <abuse@demo-mirror.invalid>
